...
export function SettingsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] max-h-[90vh] block">
        <DialogHeader>
            ...
            <div className="border-t pt-4 mt-2">
              ...
              <div className="grid gap-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Note: Language recognition quality depends on your browser and ce support. For Filipino
                  recognition, Chrome browser is recommended.
                </p>
